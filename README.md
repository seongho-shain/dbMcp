...
**교육용 AI 챗봇 플랫폼**은 선생님과 학생들이 함께 사용할 수 있는 실시간 AI 기반 교육 지원 시스템입니다. FastAPI 백엔드와 React 프론트엔드로 구성되어 있으며, OpenAI GPT 모델을 활용하여 교육적 가치가 있는 응답을 제공합니다.
...
### 💬 실시간 채팅
- **스트리밍 응답**: OpenAI API를 통한 실시간 텍스트 생성
...
✅ **AI 통합**: OpenAI GPT 모델 활용  
✅ **MVC 아키텍처**: 코드 구조 개선  
✅ **채팅 히스토리**: 세션별 대화 기록  

### 개발 중 또는 계획 중 기능
🔄 **데이터베이스 연동**: Supabase 완전 통합  
🔄 **고급 파일 처리**: PDF 및 문서 파일 분석  
🔄 **실시간 알림**: 새 메시지 알림 시스템  
